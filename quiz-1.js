...
var cat16 = ($("input[@name=q16]:checked").val() != "d");  
...
var cat22 = ($("input[@name=q22]:checked").val() != "d");  

var cat23 = ($("input[@name=q23]:checked").val() != "c");  

var cat24 = ($("input[@name=q24]:checked").val() != "d");  

var cat25 = ($("input[@name=q25]:checked").val() != "a");

var cat26 = (!cat1 && !cat2 && !cat3 && !cat4 && !cat5 && !cat6 && !cat7 && !cat8 && !cat9 && !cat10 && !cat11 && !cat12 && !cat13 && !cat14 && !cat15 && !cat16 && !cat17 && !cat18 && !cat19 && !cat20 && !cat21 && !cat22 && !cat23 && !cat24 && !cat25); var categories = [];                        
